-- TikTok Dance Script (sichtbar für alle)
-- ====== HIER EINFACH DEINE ANIMATION-IDs EINFÜGEN ======

local dances = {
    {name = "Run Away", id = 123845287065196}, -- <-- ersetze 0 mit deiner Animation-ID
    {name = "Twerking", id = 91014640753525}, -- <-- ersetze 0 mit deiner Animation-ID
}
